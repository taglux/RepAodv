...
OBJS = $O/src/repaodv/Aodv.o $O/src/repaodv/trust/TrustEngine.o $O/src/repaodv/trust/TrustPolicy.o $O/src/repaodv/trust/detectors/TwoAckDetector.o $O/src/repaodv/repAodv_m.o

# Message files
MSGFILES = \
    src/repaodv/repAodv.msg
